...
claims = pd.read_csv(r"C:\Users\admin\OneDrive\Desktop\Machine_learning\supervised_machine_learning\5.e.Logistic Regression-20240730T090714Z-001\5.e.Logistic Regression\claimants.csv").convert_dtypes()
claims.info()
...
Y = Y.astype('int')  
Y.info()# Converts target variable to integer data type
...
data = pd.read_excel(r"C:\Users\admin\OneDrive\Desktop\Machine_learning\supervised_machine_learning\5.e.Logistic Regression-20240730T090714Z-001\5.e.Logistic Regression\claims_test.xlsx").convert_dtypes()
