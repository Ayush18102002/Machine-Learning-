...
# Business Problem: One of the e-commerce company is facing this issue: 
...
1. b. Data Understanding: Data Sources -> Data Collection -> Data Storage (DB, DWH, DL, DLH)                 
Data Collection: 
...
Perform EDA & generate two key documents (Business Insights & Statistical Insights)
'''
...
from sklearn.metrics.pairwise import cosine_similarity # Import cosine_similarity from scikit-learn for calculating cosine similarity between vectors
import joblib # Import joblib for saving and loading models

# Load the anime dataset from a CSV file
movies = pd.read_csv(r"C:\Users\admin\OneDrive\Desktop\Machine_learning\unsupervised_machine_learning\2025_Recommendation_Engine\Movies.csv", encoding = 'utf8')
...
movies.to_sql('movies', con = engine, if_exists = 'replace', chunksize = 1000, index = False)
