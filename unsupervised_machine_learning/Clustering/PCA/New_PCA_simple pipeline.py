...
import dtale  # Importing Sweetviz library for automated EDA
...
University = pd.read_excel(r"C:\Users\admin\Downloads\PCA (5)\PCA\University_Clustering.xlsx")
...
University.to_sql('university_pca', con = engine, if_exists = 'replace', chunksize = 1000, index = False)

# Loading data from the 'university_clustering' table in the database into a DataFrame
sql = 'select * from university_pca'
...
newdf = pd.read_excel(r"C:\Users\admin\Downloads\PCA (5)\PCA\new_Univ_4_pred.xlsx")
