...
# CRISP-ML(Q):
    Business & Data Understanding:
        ...
        HLD - DAR - DLD # Watch AI for Business Professionals for better understanding
...
# Maintain Code Modularity (Blocks of code, which are used to perform a specific activity)
...
University = pd.read_excel(r"C:/Users/Bharani Kumar/Desktop/Data Analytics/Dimension Reduction/SVD/University_SVD.xlsx")
...
University.to_sql('university_svd', con = engine, if_exists = 'replace', chunksize = 1000, index = False)

# SQL query to select all records from the 'university_clustering' table
sql = 'select * from university_svd'
...
# Define TruncatedSVD model with 6 components
...
newdf = pd.read_excel(r"C:/Users/Bharani Kumar/Desktop/Data Analytics/Dimension Reduction/SVD/new_Univ_4_pred.xlsx")
